...
import { Bot, Check, Droplet, Pencil, Send, Shield } from "lucide-react";
import {
  CustomerBottomNav,
...
function OrderDraftCard({
  ...
  return (
    <div className="mt-3 overflow-hidden rounded-2xl border border-[#d5e1ec] bg-[#f5f9fc]">
...
export default function CustomerTableChat({
  ...
  const confirmOrderDraft = async (orderId: number) => {
    ...
    const payload = (await response.json()) as { order: OrderDraft };
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {msg.sender === "assistant" && msg.orderDraft ? (
                    <OrderDraftCard
